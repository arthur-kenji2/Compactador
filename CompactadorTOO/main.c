...
int compactar()
{
    ...
    printf("Digite o nome do arquivo em que o arquivo original sera compactado: \n");
    scanf("%s", nomeArqEsc);
    ...
    noArvore *raiz = construirArvHuffman(lBytes);
...
int descompactar()
{
    ...
    printf("Digite o nome do arquivo em que o arquivo original sera descompactado: \n");
    scanf("%s", nomeArqEsc);
